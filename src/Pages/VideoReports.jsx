...
export default function ReportedVideos() {
    ...
    const fetchReports = async () => {
        try {
            const res = await axios.get('https://earnkar-backend-code.vercel.app/api/auth/getreportVideo');
    ...
    const handleDeleteVideo = async (report) => {
        ...
        try {
            await axios.delete(`https://earnkar-backend-code.vercel.app/api/auth/deleteVideo/${videoId}`);
